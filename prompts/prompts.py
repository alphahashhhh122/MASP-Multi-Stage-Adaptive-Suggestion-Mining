...
DOMAIN_HN_KEYWORDS = {
    "tech_software": {
        "praise": ["love it", "great job", "impressed", "best ever", "5 stars",
                    "highly recommend", "wonderful", "outstanding", "blown away",
                    "no complaints", "absolutely love", "really happy", "so glad",
                    "perfect", "love this app", "works perfectly", "great update"],
        "sarcasm": ["it is what it is", "not for me", "or maybe not",
                    "i guess", "if you say so", "sure thing", "whatever",
                    "oh great", "what a feature", "brilliant design"],
        "status_quo": ["don't change", "keep it as", "love it as is", "please don't"],
        "resolved": ["they fixed it", "was fixed", "already resolved", "working now",
                     "no longer an issue", "latest update fixed", "patched"],
    },
    "restaurant": {
        "praise": ["love it", "great job", "impressed", "best ever", "5 stars",
                    "highly recommend", "wonderful", "outstanding", "blown away",
                    "no complaints", "amazing food", "best meal", "incredible",
                    "perfect evening", "delicious", "fantastic service"],
        "sarcasm": ["it is what it is", "not for me", "or maybe not",
                    "i guess", "if you say so", "sure thing", "whatever",
                    "oh great", "what a treat", "lovely experience"],
        "status_quo": ["don't change", "keep it as", "love it as is",
                       "keep the recipe", "don't touch the menu"],
        "resolved": ["they fixed it", "was fixed", "already resolved",
                     "under new management now", "they renovated",
                     "much better now", "improved since last visit"],
    },
}
